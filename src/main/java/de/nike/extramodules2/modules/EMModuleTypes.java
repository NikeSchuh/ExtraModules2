...
public class EMModuleTypes {
	...
	public static final ModuleType<EffectData> EFFECT = new ModuleTypeImpl<>("effect", 1, 2, EffectEntity::new, new ModuleCategory[] {EMModuleCategories.EFFECT}).setMaxInstallable(-1);
}
