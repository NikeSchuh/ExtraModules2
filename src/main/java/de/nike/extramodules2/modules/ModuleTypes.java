...
public class ModuleTypes {
	...
	public static final ModuleType<DefenseSystemData> DEFENSE_SYSTEM = new ModuleTypeImpl<>("defense_system", 1, 1, new ModuleCategory[] {ModuleCategory.CHESTPIECE, ModuleCategory.ARMOR_CHEST}).setMaxInstallable(-1);
